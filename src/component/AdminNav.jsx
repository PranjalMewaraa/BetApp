...
const NavA = () => {
  return (
    <div className="w-full h-36 md:h-12 flex md:flex-row flex-col justify-between mb-4 items-center">
      <p className="ml-4  text-5xl flex h-12 items-center text-red-600 font-[founder]">
      ...
      <div className="h-[95%] flex gap-8 items-center">
        <ul className="w-fit flex gap-3 flex-wrap items-center justify-center pr-4">
          <Link
            to={"/admin"}
